...
const PropertyDescription = () => {
  return (
    <section>
        <h1 className='text-xl font-semibold text-foreground-secondary mb-2'> Property description </h1>
        ...
        <button className='text-sm font-bold text-action-accent cursor-pointer mt-1'>
            Read more 
        </button>
    </section>
  )
